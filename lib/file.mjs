...
const API_CLIENT_SECRET = process.env.API_CLIENT_SECRET || "duzp0kzwDHSS2nSO46P3GBGsNnQbx5L3";
const API_TOKEN_URL = process.env.API_TOKEN_URL || "http://localhost:8080/realms/Artcoded/protocol/openid-connect/token";
...
export async function downloadAndSave(id) {
  ...
  const response = await fetch(`${API_BACKEND_URL}/api/resource/download?id=${id}`, {
    method: "get",
    headers: {
